...
public:
	...
	void setGuis()
	{
		m_playerPokemonInfo->addProgressBar(m_playerPokemonInfo->getPosition().x, m_playerPokemonInfo->getPosition().y + 40, m_playerPokemonInfo->getSize().x / 3, m_playerPokemonInfo->getSize().y / 6, sf::Color::Black, sf::Color::Green, m_currentPlayerPokemon->getHpPercent());
		...
		m_enemyPokemonInfo->addProgressBar(m_enemyPokemonInfo->getPosition().x, m_enemyPokemonInfo->getPosition().y + 40, m_enemyPokemonInfo->getSize().x / 3, m_enemyPokemonInfo->getSize().y / 6, sf::Color::Black, sf::Color::Green, m_enemyPokemon->getHpPercent());
